...
namespace PM.WebServices.Commands.Handlers
{
    public class ParkingCommandHandler
    {
        ...
        public ParkingCommandHandler(DbContext dbContext, CommandStoreService commandStoreService, AuthenticationService authenticationService)
        {
